...
theorem toMatOf_congr (bE bE' : OrthonormalBasis ι ℂ E) (bF bF' : OrthonormalBasis κ ℂ F)
  ...
  haveI : FiniteDimensional ℂ E := Module.Basis.finiteDimensional_of_finite bE.toBasis
  haveI : FiniteDimensional ℂ F := Module.Basis.finiteDimensional_of_finite bF.toBasis
  refine LinearMap.ext fun M ↦ ?_
