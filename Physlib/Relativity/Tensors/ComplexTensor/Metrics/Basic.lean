...
lemma actionT_coMetric (g : SL(2,ℂ)) : g • η' = η' := metricTensor_invariant g

/-- The tensor `contrMetric` is invariant under the action of `SL(2,ℂ)`. -/
lemma actionT_contrMetric (g : SL(2,ℂ)) : g • η = η := metricTensor_invariant g

/-- The tensor `leftMetric` is invariant under the action of `SL(2,ℂ)`. -/
lemma actionT_leftMetric (g : SL(2,ℂ)) : g • εL = εL := metricTensor_invariant g

/-- The tensor `rightMetric` is invariant under the action of `SL(2,ℂ)`. -/
lemma actionT_rightMetric (g : SL(2,ℂ)) : g • εR = εR := metricTensor_invariant g

/-- The tensor `dualLeftMetric` is invariant under the action of `SL(2,ℂ)`. -/
lemma actionT_dualLeftMetric (g : SL(2,ℂ)) : g • εL' = εL' := metricTensor_invariant g

/-- The tensor `dualRightMetric` is invariant under the action of `SL(2,ℂ)`. -/
lemma actionT_dualRightMetric (g : SL(2,ℂ)) : g • εR' = εR' := metricTensor_invariant g
